...
* insert createInitialMessageSetup(ok, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-ok.xml, destinationUri-ok, bundleid-ok)
* insert readMessage(ok, 01, bundleid-ok)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(ok, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-ok.xml, destinationUri-ok, bundleid-ok)
* insert createMessageSetup(ok2, 02, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-ok.xml, bundleid-ok2)
* insert readMessage(ok, 01, bundleid-ok)
* insert readMessage(ok2, 02, bundleid-ok2)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(fatal-error, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-fatal-error.xml, destinationUri-fatal-error, bundleid-fatal-error)
* insert readMessage(fatal-error, 01, bundleid-fatal-error)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(fatal-error, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-fatal-error.xml, destinationUri-fatal-error, bundleid-fatal-error)
* insert createMessageSetup(fatal-error2, 02, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-fatal-error.xml, bundleid-fatal-error2)
* insert readMessage(fatal-error, 01, bundleid-fatal-error)
* insert readMessage(fatal-error2, 02, bundleid-fatal-error2)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(transient-error, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-transient-error.xml, destinationUri-transient-error, bundleid-transient-error)
* insert readMessage(transient-error, 01, bundleid-transient-error)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(transient-error, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-transient-error.xml, destinationUri-transient-error, bundleid-transient-error)
* insert createMessageSetup(transient-error2, 02, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-transient-error.xml, bundleid-transient-error2)
* insert readMessage(transient-error, 01, bundleid-transient-error)
* insert readMessage(transient-error2, 02, bundleid-transient-error2)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(transient-error, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-transient-error.xml, destinationUri-transient-error, bundleid-transient-error)
* insert createMessageSetup(ok, 02, /FHIRSandbox/MedCom/Acknowledgement/draft/Receive/Fixtures/Acknowledgement-fixture-ok.xml, bundleid-ok)
* insert readMessage(transient-error, 01, bundleid-transient-error)
* insert readMessage(ok, 02, bundleid-ok)

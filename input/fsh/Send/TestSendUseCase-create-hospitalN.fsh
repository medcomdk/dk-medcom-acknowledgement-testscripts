...
* insert createInitialMessageSetup(STIN, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-ok.xml, destinationUri-STIN, bundleid-STIN-01)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(STIN, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-fatal-error.xml, destinationUri-STIN, bundleid-STIN-01)
* insert readMessage(STIN, 01, bundleid-STIN-01)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(STIN, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-transient-error.xml, destinationUri-STIN, bundleid-STIN-01)
* insert readMessage(STIN, 01, bundleid-STIN-01)
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(STIN, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-ok.xml, destinationUri-STIN, bundleid-STIN-01)
* insert createMessageSetup(STIN2, 03, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-ok.xml, bundleid-STIN2-03)
* insert readMessage(STIN, 01, bundleid-STIN-01)
* insert createMessageDuplicate(ok, 02, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/Acknowledgement-fixture.xml, revision, messageHeaderid-STIN) 
* insert readMessage(STIN2, 03, bundleid-STIN2-03)
* insert createMessageDuplicate(ok, 04, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/Acknowledgement-fixture.xml, revision, messageHeaderid-STIN2) 
...
* name = "AcknowledgementTestScript"
* insert createInitialMessageSetup(STIN, 01, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-fatal-error.xml, destinationUri-STIN, bundleid-STIN-01)
* insert createMessageSetup(STIN2, 03, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-fatal-error.xml, bundleid-STIN2-03)
* insert readMessage(STIN, 01, bundleid-STIN-01)
* insert createMessageDuplicate(fatal-error, 02, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/Acknowledgement-fixture.xml, revision, messageHeaderid-STIN) 
* insert readMessage(STIN2, 03, bundleid-STIN2-03)
* insert createMessageDuplicate(fatal-error, 04, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/Acknowledgement-fixture.xml, revision, messageHeaderid-STIN2) 
...
* insert createMessageSetup(STIN2, 03, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/HospitalNotification-fixture-STIN-ok.xml, bundleid-STIN2-03)
* insert readMessage(STIN, 01, bundleid-STIN-01)
* insert createMessageDuplicate(transient-error, 02, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/Acknowledgement-fixture.xml, revision, messageHeaderid-STIN) 
* insert readMessage(STIN2, 03, bundleid-STIN2-03)
* insert createMessageDuplicate(ok, 04, /FHIRSandbox/MedCom/Acknowledgement/draft/Send/Fixtures/Acknowledgement-fixture.xml, revision, messageHeaderid-STIN2) 
